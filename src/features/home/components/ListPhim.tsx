    ...
    <div className="w-full px-2 py-4">
      <div className="flex gap-2 mb-4">
        {FILTERS.map((f) => (
          <button
            ...
            onClick={() => setMovieFilter(f.value)}
          >
            {f.label}
          </button>
        ))}
      ...
      <div className="flex justify-center items-center gap-2 mt-6">
        <button
          ...
          onClick={() => currentPage > 1 && setMoviePage(currentPage - 1)}
        ...
        <button
          className="px-3 py-1 rounded border transition-colors duration-200 font-medium bg-white text-gray-700 border-gray-300 hover:bg-blue-50 disabled:opacity-50"
          onClick={() => currentPage < totalPage && setMoviePage(currentPage + 1)}
