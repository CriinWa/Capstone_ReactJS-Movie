...
//   };
    ...
    //nếu đã đăng nhập rồi thì không cho vào trang sign-in nữa, chuyển hướng về trang home
    //nếu dùng useEffect để chuyển hướng thì sẽ bị render 2 lần, thấy form SignIn rồi mới chuyển hướng, dùng Navigate sẽ tốt hơn
    ...
    <div className="flex items-center justify-center w-full">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="p-6 pt-0">
            ...
            <a className="ml-1 block font-sans text-sm font-bold leading-normal text-cyan-500 antialiased" href={PATH.SIGN_UP}>
                Sign up
            </a>
            </p>
        </div>
